...
export default function SaleGeneration() {
  const salesGeneration = {
    ...
    data: [{
      ...
      url: "/services/sales-generation/lead-generation-specialist",
    }, {
      ...
      url: "/services/sales-generation/telesales-specialist",
    }, {
      ...
      url: "/services/sales-generation/outbound-sales-agent",
    }, {
      ...
      url: "/services/sales-generation/telemarketer",
    }, {
      ...
      url: "/services/sales-generation/sale-business-development-specialist",
    }]
  } 
