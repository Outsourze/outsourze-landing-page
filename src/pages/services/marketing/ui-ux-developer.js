...
export default function UiUxDeveloper() {
    ...
    return (
      <>
        <SEO
          title="UI/UX Outsourcing Services | Outsourze"
          description="Improve user experience with Outsourze's remote UI/UX developers—intuitive designs, user-friendly interfaces, and optimized engagement."
          url={`${process.env.NEXT_PUBLIC_BASE_URL}/marketing/ui-ux-developer`}
        />
