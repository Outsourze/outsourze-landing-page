...
export default function PsychometricTesting() {
    ...
    return (
      <>
        <SEO
          title="Psychometric Testing Services | Outsourze"
          description="Leverage Outsourze's psychometric testing solutions to assess candidate's skills, personality, and fit. Hire smarter with data-driven insights."
          url={`${process.env.NEXT_PUBLIC_BASE_URL}/services/hr-recruitment/psychometric-testing`}
        />
